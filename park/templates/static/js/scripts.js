(window.mr = window.mr || {}),
  (mr = (function (a, b, c, d) {
    ...
    return (
      (a.status = { documentReadyRan: !1, windowLoadPending: !1 }),
      b(d).ready(e),
      b(c).on("load", f),
    ...
    (a.scroll.classModifiers = {}),
      ...
      (a.scroll.classModifiers.update = function (b) {
        for (
          var c,
            d = a.scroll.y,
            e = a.scroll.classModifiers.rules,
            f = e.length;
          f--;
          ...
          (c = e[f]),
            d > c.scrollPoint &&
              !c.hasClass &&
              (c.element.classList.add(c.toggleClass),
              (c.hasClass = a.scroll.classModifiers.rules[f].hasClass = !0)),
            d < c.scrollPoint &&
              c.hasClass &&
              (c.element.classList.remove(c.toggleClass),
      ...
      f = function (b) {
        b("[data-scroll-class]").each(function () {
          ...
          a.scroll.classModifiers.rules.length &&
            a.scroll.listeners.push(a.scroll.classModifiers.update);
      };
    return (
      a.components.documentReady.push(f),
    ...
    return (
      ...
      (a.accordions.documentReady = function (b) {
        b(".accordion__title").on("click", function () {
          ...
          "" !== c.location.hash &&
            "#" !== c.location.hash &&
            null === c.location.hash.match(/#\/.*/) &&
            b(".accordion > li > .accordion__title" + c.location.hash).length &&
            a.accordions.activatePanelById(c.location.hash, !0),
          jQuery(d).on("click", 'a[href^="#"]:not(a[href="#"])', function () {
            b(".accordion > li > .accordion__title" + b(this).attr("href"))
              .length &&
      ...
      (a.accordions.activatePanel = function (a, c) {
        ...
        if (
          (h.initEvent("panelOpened.accordions.mr", !0, !0),
          i.initEvent("panelClosed.accordions.mr", !0, !0),
          g.hasClass("active"))
        )
          c !== !0 &&
            (g.removeClass("active"),
            e.trigger("panelClosed.accordions.mr").get(0).dispatchEvent(i));
        else if (f.hasClass("accordion--oneopen")) {
          var j = f.find("li.active");
          j.length &&
            (j.removeClass("active"),
            j.trigger("panelClosed.accordions.mr").get(0).dispatchEvent(i)),
            g.addClass("active"),
      ...
      (a.accordions.activatePanelById = function (c, d) {
        ...
        "" !== c &&
          "#" !== c &&
          null === c.match(/#\/.*/) &&
          ((e = b(".accordion > li > .accordion__title#" + c.replace("#", ""))),
          e.length &&
            (b("html, body")
              .stop(!0)
              .animate({ scrollTop: e.offset().top - 50 }, 1200),
            a.accordions.activatePanel(e, d)));
      }),
      ...
      (a.countdown.documentReady = function (b) {
        b(".countdown[data-date]").each(function () {
          var c,
            ...
            e = d.attr("data-date"),
            f =
              "undefined" != typeof d.attr("data-days-text")
                ? "%D " + d.attr("data-days-text") + " %H:%M:%S"
                : "%D days %H:%M:%S",
            f =
              "undefined" != typeof a.countdown.options.format
                ? a.countdown.options.format
                : f,
            g =
              "undefined" != typeof d.attr("data-date-format")
                ? d.attr("data-date-format")
                : f;
          "undefined" != typeof d.attr("data-date-fallback") &&
            (c = d.attr("data-date-fallback") || "Timer Done"),
  ...
  (mr = (function (a, b, c, d) {
    ...
    return (
      (a.datepicker.documentReady = function (a) {
              ...
              function (a) {
                ...
                jQuery(a.target).is(".dropdown--active > .dropdown__trigger")
                  ? (c
                      ...
                      .find(".dropdown")
                      .removeClass("dropdown--active"),
                    c.toggleClass("dropdown--active"))
                  : (b(".dropdown--active").removeClass("dropdown--active"),
      ...
      (a.dropdowns.repositionDropdowns = function (a) {
        a(".dropdown__container").each(function () {
          ...
          jQuery(this).css("left", ""),
            ...
            (e = null),
            a.css("left", -b + c),
            a.find('.dropdown__content:not([class*="lg-12"])').length &&
              ((e = a.find(".dropdown__content")), e.css("left", d - c));
        }),
      ...
      (a.dropdowns.repositionDropdownsRtl = function (a) {
        ...
        a(".dropdown__container").each(function () {
          ...
          jQuery(this).css("left", ""),
            ...
            (e =
              b -
              (a.closest(".dropdown").offset().left +
                a.closest(".dropdown").outerWidth(!0))),
            (f = null),
            a.css("right", -c + d),
            a.find('.dropdown__content:not([class*="lg-12"])').length &&
              ((f = a.find(".dropdown__content")), f.css("right", e - d));
        }),
          a(".dropdown__content").each(function () {
            var a, d, e, f, g, h;
            (a = jQuery(this)),
    ...
    return (
        ...
        (a.forms.captcha.widgets = []),
          ...
          b(
            ...
            (g = i.attr("data-recaptcha-theme")),
              ...
              j.length ||
                ((b = i.find("button[type=submit]").closest('[class*="col-"]')),
                (j = jQuery("<div>").addClass("recaptcha")),
                (c = jQuery("<div>").addClass("col-12").append(j)),
                c.insertBefore(b)),
              (d = { element: j.get(0), parentForm: i, theme: g, size: h }),
              a.forms.captcha.widgets.push(d),
              a.forms.captcha.done === !1
                ? jQuery('script[src*="recaptcha/api.js"]').length ||
                  ((e = jQuery("<script async defer>")),
                  (f =
                    "https://www.google.com/recaptcha/api.js?onload=mrFormsCaptchaInit&render=explicit"),
                  e.attr("src", f),
                  jQuery("body").append(e),
                  (a.forms.captcha.done = !0))
            ...
            1 === n
              ...
              : (k.removeClass("attempted-submit"),
                ...
                jQuery.ajax({
                  type: "POST",
                  url:
                    "" !== l ? l : "http://mailform.mediumra.re/stack/mail.php",
                  data:
                    k.serialize() + "&url=" + c.location.href + "&captcha=" + p,
                  success: function (d) {
                    m.removeClass("btn--loading"),
                      b.isNumeric(d)
                        ? parseInt(d, 10) > 0 &&
      ...
      (a.forms.validateFields = function (a) {
        ...
        if (
          ...
          a.find("div.recaptcha").length &&
            "undefined" != typeof a.attr("data-recaptcha-sitekey") &&
            ((d = b(a.find("div.recaptcha"))),
            "" !== grecaptcha.getResponse(a.data("recaptchaWidgetID"))
              ? d.removeClass("field-error")
              : (d.addClass("field-error"), (f = 1))),
          ...
          g.length &&
            b("html, body")
              .stop(!0)
              .animate({ scrollTop: g.offset().top - 100 }, 1200, function () {
                g.focus();
              });
      ...
      (a.forms.captcha.renderWidgets = function () {
        a.forms.captcha.widgets.forEach(function (b) {
          "" === b.element.innerHTML.replace(/[\s\xA0]+/g, "") &&
      ...
      (a.granim.documentReady = function (b) {
        b("[data-gradient-bg]").each(function (c, d) {
          var e,
            ...
            o = {};
          if (
            (j.prepend('<canvas id="' + k + '"></canvas>'),
            (f = /^(#[0-9|a-f|A-F]{6}){1}([ ]*,[ ]*#[0-9|a-f|A-F]{6})*$/.test(
              l
            )),
            f === !0)
          ) {
          ...
          (h = {
            ...
            states: { "default-state": { gradients: m } },
          }),
    ...
    return (
      ...
      (a.instagram.documentReady = function (b) {
        ...
        if (b(".instafeed").length) {
          ...
          b(".instafeed[data-access-token][data-client-id]").length &&
            ((f = b(".instafeed[data-access-token][data-client-id]")
              .first()
              .attr("data-access-token")),
            (g = b(".instafeed[data-access-token][data-client-id]")
              .first()
              .attr("data-client-id")),
            "" !== f && (h = f),
            "" !== g && (i = g)),
        ...
        b(".instafeed").each(function () {
          ...
          (c = { query: "mediumrarethemes", max: 12 }),
        ...
        "undefined" != typeof c.google &&
          ...
          jQuery(".gmaps-active").each(function () {
            var b,
              ...
              m =
                ("undefined" != typeof k.attr("data-zoom-controls") ? !0 : !1,
                "undefined" != typeof k.attr("data-zoom-controls")
                  ? k.attr("data-zoom-controls")
                  : !1),
              n =
                "undefined" != typeof k.attr("data-latlong")
                  ? k.attr("data-latlong")
                  : !1,
              ...
              r =
                "undefined" != typeof k.attr("data-address")
            ...
            (i = d.createEvent("Event")),
              ...
              (t.icon =
                "undefined" != typeof k.attr("data-marker-image")
                  ? {
                ...
                ? q.geocode(
                    ...
                    function (c, d) {
                      d === google.maps.GeocoderStatus.OK &&
                        ((b = new google.maps.Map(j, g)),
                        a.maps.instances.push(b),
                        jQuery(j)
                          .trigger("mapCreated.maps.mr")
                          .get(0)
                          .dispatchEvent(i),
                        b.setCenter(c[0].geometry.location),
    ...
    return (
          ...
          b(d).on(
            ...
            function () {
              var a = b(this),
                ...
                d = "*";
              "*" !== a.attr("data-masonry-filter") &&
                (d = ".filter-" + a.attr("data-masonry-filter")),
      ...
      (a.masonry.windowLoad = function () {
        b(".masonry").each(function () {
          ...
          (c = {
            ...
            e.is("[data-default-filter]") &&
              ((f = e.attr("data-default-filter").toLowerCase()),
              (f = ".filter-" + f),
              e.find("li[data-masonry-filter]").removeClass("active"),
              e
                .find(
                  'li[data-masonry-filter="' +
                    e.attr("data-default-filter").toLowerCase() +
                    '"]'
                )
                .addClass("active")),
            (g.filter = "*" !== f ? f : void 0),
      ...
      (a.masonry.updateFilters = function (c) {
        ...
        d.each(function () {
          var c,
            ...
            g =
              "undefined" != typeof f.attr("data-filter-all-text")
                ? f.attr("data-filter-all-text")
                : "All";
          d.is(".masonry") &&
            e.find(".masonry__item[data-masonry-filter]").length &&
            ((c = f.find("> ul")),
            c.length || (c = f.append("<ul></ul>").find("> ul")),
            e.find(".masonry__item[data-masonry-filter]").each(function () {
              ...
              "undefined" != typeof e && "" !== e && (f = e.split(",")),
                b(f).each(function (b, e) {
                  ...
                  d.addClass("filter-" + f),
                    c.find('[data-masonry-filter="' + f + '"]').length ||
                      c.append(
                        '<li data-masonry-filter="' + f + '">' + e + "</li>"
                      );
                });
            }),
            c.find("[data-masonry-filter]").each(function () {
              var a = b(this),
                c = a.text();
              "*" !== b(this).attr("data-masonry-filter") &&
                (d.find('.masonry__item[data-masonry-filter*="' + c + '"]')
                  .length ||
                  a.remove());
            }),
            a.util.sortChildrenByText(b(this).find(".masonry__filters ul")),
            c.find('[data-masonry-filter="*"]').length ||
              c.prepend(
                '<li class="active" data-masonry-filter="*">' + g + "</li>"
              ));
        });
      }),
      (a.masonry.updateLayout = function (a) {
        ...
        c.each(function () {
          ...
          a.is(".masonry") &&
            (c.length && d.isotope("appended", c).isotope("layout"),
            d.isotope("layout"));
        });
      }),
  ...
  (mr = (function (a, b, c, d) {
    ...
    return (
      ...
      (a.modals.documentReady = function (b) {
        ...
        if (
          (f.length
            ? (jQuery(e).insertAfter(f),
              (a.modals.allModalsContainer = b("div.all-page-modals")))
            : (jQuery("body").append(e),
              (a.modals.allModalsContainer = jQuery(
          ...
          b(".modal-container").each(function () {
            ...
            if (
              ...
              var f =
                ...
                e
                  .attr("data-width")
                  .substr(0, e.attr("data-width").indexOf("%"));
              e.css("width", f + "%");
            }
            if (void 0 !== e.attr("data-height")) {
              var g =
                ...
                e
                  .attr("data-height")
                  .substr(0, e.attr("data-height").indexOf("%"));
              e.css("height", g + "%");
            }
          ...
          b(".modal-instance").each(function (c) {
            ...
            f.attr("data-modal-index", c),
              ...
              "undefined" != typeof e.attr("data-modal-id") &&
                f.attr("data-modal-id", e.attr("data-modal-id")),
              (e = e.detach()),
          ...
          b(".modal-trigger").on("click", function () {
            ...
            return (
              "undefined" != typeof e.attr("data-modal-id")
                ? ((c = e.attr("data-modal-id")),
                  (d = a.modals.allModalsContainer.find(
          ...
          b(".modal-container:not(.modal--prevent-close)").on(
            "click",
            function (b) {
          ...
          b(".modal-container[data-show-on-exit]").each(function () {
            var c = jQuery(this),
              ...
              f = 0;
            c.attr("data-delay") &&
              (f = parseInt(c.attr("data-delay"), 10) || 0),
              b(e).length &&
                (c.prepend(b('<i class="ti-close close-modal">')),
      ...
      (a.modals.closeActiveModal = function () {
        ...
        a.util.idleSrc(b, "iframe"),
          a.util.pauseVideo(b),
          "undefined" != typeof b.attr("data-cookie") &&
            a.cookies.setItem(b.attr("data-cookie"), "true", 1 / 0, "/"),
          b.length &&
            (b.is("[data-modal-id]") &&
              c.location.hash === "#" + b.attr("data-modal-id") &&
              a.util.removeHash(),
            ...
            c.is(".form--no-placeholders")
              ...
              : c.find("input:not([checkbox]):not([radio])").each(function () {
                  ...
                  "undefined" != typeof a.attr("placeholder")
                    ? "" === a.attr("placeholder") &&
                      a.siblings("label").length &&
                      (a.attr(
                        "placeholder",
                        a.siblings("label").first().text()
                      ),
                      c.is(".form--no-labels") &&
                        a.siblings("label").first().remove())
                    : a.siblings("label").length &&
                      (a.attr(
                        "placeholder",
                        a.siblings("label").first().text()
          ...
          b('form[action*="list-manage.com"]').each(function () {
            (c = b(this)),
              ...
              c.find("input").each(function () {
                var a = b(this);
                a.hasClass("required") &&
                  a.removeClass("required").addClass("validate-required");
              }),
              c
    ...
    return (
      ...
      (a.notifications.documentReady = function (b) {
        b(".notification").each(function () {
          var a = b(this);
          a.find(".notification-close").length ||
            a.append(
          ...
          b("[data-notification-link]:not(.notification)").on(
            "click",
            function () {
  ...
  (mr = (function (a, b, c, d) {
    "use strict";
    return (
      (a.progressHorizontal = a.progressHorizontal || {}),
  ...
  (mr = (function (a, b, c, d) {
    "use strict";
    return (
      (a.easypiecharts = a.easypiecharts || {}),
      ...
      (a.easypiecharts.documentReady = function (b) {
        b(".radial").each(function () {
          var b,
            ...
            i = {};
          (h = {
            animate: { duration: e, enabled: !0 },
            barColor: d,
            scaleColor: !1,
            size: f,
            lineWidth: g,
          }),
            "undefined" != typeof a.easypiecharts.options.size &&
              (f = a.easypiecharts.options.size),
            "undefined" != typeof c.attr("data-timing") &&
              (i.animate = {
                duration: parseInt(c.attr("data-timing"), 10),
                enabled: !0,
              }),
            "undefined" != typeof c.attr("data-color") &&
              (i.barColor = c.attr("data-color")),
            "undefined" != typeof c.attr("data-size") &&
              (f = i.size = parseInt(c.attr("data-size"), 10)),
            "undefined" != typeof c.attr("data-bar-width") &&
              (i.lineWidth = parseInt(c.attr("data-bar-width"), 10)),
            c.css("height", f).css("width", f),
            "object" == typeof a.easypiecharts.options &&
              (b = jQuery.extend({}, h, a.easypiecharts.options, i)),
            c.easyPieChart(b),
            c.data("easyPieChart").update(0);
        }),
          b(".radial").length &&
            (a.easypiecharts.init(b),
      ...
      (a.easypiecharts.activate = function () {
        a.easypiecharts.pies.forEach(function (b) {
          Math.round(a.scroll.y + a.window.height) >=
            Math.round(b.top + b.height) &&
            b.active === !1 &&
            (b.element.data("easyPieChart").enableAnimation(),
      ...
      (a.sliders.documentReady = function (b) {
        b(".slider").each(function (c) {
          ...
          var f = e.find("li").length,
            ...
            h = {};
          (h.pageDots =
            "true" === d.attr("data-paging") && e.find("li").length > 1
              ? !0
              : void 0),
            (h.prevNextButtons =
              "true" === d.attr("data-arrows") ? !0 : void 0),
            (h.draggable = "false" === d.attr("data-draggable") ? !1 : void 0),
            (h.autoPlay =
              "false" === d.attr("data-autoplay")
                ? !1
                : d.attr("data-timing")
                ? parseInt(d.attr("data-timing"), 10)
                : void 0),
            (h.accessibility =
              "false" === d.attr("data-accessibility") ? !1 : void 0),
            ...
            b(this).data(
              "sliderOptions",
              jQuery.extend({}, g, a.sliders.options, h)
            ),
      ...
      (a.smoothscroll.highlight = function () {
        a.smoothscroll.sections.forEach(function (b) {
          a.scroll.y >= b.top && a.scroll.y < b.top + b.height
            ? b.active === !1 &&
              (b.link.classList.add("inner-link--active"), (b.active = !0))
      ...
      (a.smoothscroll.documentReady = function (b) {
        ...
        (e = {
          ...
          f.length &&
            ...
            (d = 0),
            b("body[data-smooth-scroll-offset]").length &&
              ((d = b("body").attr("data-smooth-scroll-offset")), (d = 1 * d)),
            (g.offset = 0 !== d ? d : void 0),
          ...
          .each(function (c) {
            ...
            (f = jQuery.extend(f, a.twitter.options)),
              "undefined" != typeof e.attr("data-widget-id")
                ...
                : "undefined" != typeof e.attr("data-feed-name") &&
                  "" !== e.attr("data-feed-name")
                ? (f.profile = {
  ...
  (mr = (function (a, b, c, d) {
    ...
    return (
      ...
      (a.video.documentReady = function (b) {
        b(".youtube-background").length &&
          b(".youtube-background").each(function () {
            var c = b(this),
          ...
          b(".video-cover").each(function () {
            var a = b(this);
            a.find("iframe[src]").length &&
              (a.find("iframe").attr("data-src", a.find("iframe").attr("src")),
      ...
      (a.wizard.documentReady = function (b) {
        b(".wizard").each(function () {
          ...
          (c = {
            ...
            b.is('[role="application"][id^="steps-uid"]') ||
              (b.steps(jQuery.extend({}, c, a.wizard.options)),
              b.addClass("active"));
        });
      }),
